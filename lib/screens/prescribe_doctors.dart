...
class PrescribeDoctor extends StatefulWidget {
  static String id = 'PrescribeDoctor';
  @override
  _PrescribeDoctorState createState() => _PrescribeDoctorState();
}

class _PrescribeDoctorState extends State<PrescribeDoctor> {
